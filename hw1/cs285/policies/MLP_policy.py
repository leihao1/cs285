...
class MLPPolicy(BasePolicy):
    ...
    def define_forward_pass(self):
        # 1TODO implement this build_mlp function in tf_utils
    ...
    def get_action(self, obs):
        ...
        # 1TODO return the action that the policy prescribes
        ...
        return self.sess.run(self.sample_ac, {self.observations_pl: observation})[0]
...
class MLPPolicySL(MLPPolicy):
    ...
    def define_train_op(self):
        ...
        # 1TODO define the loss that will be used to train this policy
